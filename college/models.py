...
class Term(models.Model):
    name = models.CharField(max_length=256)
    students = models.ManyToManyField(to='accounts.models.Student', related_name='term_student')
    professors = models.ManyToManyField(to='accounts.models.Professor', related_name='term_professor')
    TermCourses = models.ManyToManyField(to='course.models.TermCourse', related_name='term_course')
